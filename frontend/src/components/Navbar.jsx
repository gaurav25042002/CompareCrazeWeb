...
export default function StickyNavbar() {
  ...
  return (
    <div className=" max-h-[768px] w-full">
      <Navbar className="sticky top-0 z-10 h-max max-w-full rounded-none px-4 py-2 lg:px-8 lg:py-4 bg-pink-50">
        <div className="flex items-center justify-between text-blue-gray-900">
          ...
          <div className="flex justify-center items-center">
            ...
            <img
                ...
                alt="logo"
              />
              <h1 className=" text-3xl font-bold font-serif mt-2">Compare Craze</h1>
          </div>
          </Typography>
